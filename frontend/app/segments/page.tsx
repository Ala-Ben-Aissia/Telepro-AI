import { getSegments } from '@/app/api/actions'
    ...
    <div className="space-y-8">
      <header className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600">
            Create and manage patient segments for targeted campaigns
          </p>
        </div>
                  ...
                  <tr key={segment.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex flex-wrap gap-1">
                        ...
                        {segment.criteria &&
                          Object.keys(segment.criteria).length >
                            3 && (
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                      <div className="flex justify-end space-x-3">
                        ...
                        <form
                          action={`/api/segments/${segment.id}/analyze`}
                          method="POST"
                        >
                          <button
                            type="submit"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="px-4 py-5 sm:p-6">
            <p className="text-sm text-gray-500 mb-4">
              Create custom segments based on specific criteria like
              age groups, location, preferred contact methods, and
              more.
            </p>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          ...
          <div className="px-4 py-5 sm:p-6">
            <p className="text-sm text-gray-500 mb-4">
              Let AI discover patterns in your patient data and create
              intelligent segments based on behavior, engagement, and
              demographics.
            </p>
            <ul className="mt-3 list-disc list-inside text-sm text-gray-600 space-y-2">
              ...
              <li>
                Optimize campaign targeting based on AI insights
              </li>
              <li>
                Use clustering algorithms to identify natural patient
                groups
              </li>
            </ul>
            <div className="mt-6">
